GOSU_VERSION := $(shell cat GOSU_VERSION)
GOSU_DEPS := $(wildcard GOSU_*)
DOCKER_TAG_PREFIX := rzuckerm/gosu:$(GOSU_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(GOSU_DEPS)
